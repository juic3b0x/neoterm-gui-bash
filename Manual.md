...
## Description
Sets up a connection to the NeoTerm:GUI plugin through a small C helper, defines functions to interact with the plugin and finally sources the parameter into the script, so the functions are available.  
...
More documentation for the functions as defined in the protocol is available [here](https://github.com/neoterm/neoterm-gui/blob/main/Protocol.md#protocol-methods).
...
For more information about events, see [the protocol specification](https://github.com/neoterm/neoterm-gui/blob/main/Protocol.md#events).
...
Defaults to the NeoTerm:GUI app icon if left empty.
...
## Bugs
Report bugs as GitHub issues: <https://github.com/tareksander/neoterm-gui-bash/issues>
