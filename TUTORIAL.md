...
the [crash course](https://github.com/neoterm/neoterm-gui).  
...
With that, you can parse the events you need according to the [protocol definition](https://github.com/neoterm/neoterm-gui/blob/main/Protocol.md#events).
...
The `base64` command is preinstalled in NeoTerm.  
...
This make for a great user experience with NeoTerm, as exiting the dialog drops you right back into the terminal without animation.
...
NeoTerm:GUI allows you to create widgets which programs can fill.  
...
If you want to see full programs using this, look at [the examples](https://github.com/tareksander/neoterm-gui-bash/tree/main/examples).
